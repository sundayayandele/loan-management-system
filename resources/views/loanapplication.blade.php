		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Menu Dashboard</span>
              ...
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard</span>
					...
					<!--Profile Route-->
					<form action="{{route('profilec', encrypt(Auth::user()->id))}}" method="POST">
									@csrf
					...
					<li class="sidebar-item" >
						<a class="sidebar-link" href="{{route('analyticsView',encrypt(Auth::user()->id))}}">
              ...
              <i class="align-middle" data-feather="log-in"></i> <span class="align-middle" style="color:white">Apply for a Loan Now.</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="book"></i> <span class="align-middle" style="color:white">Settle Balance</span>
            </a>
					</li>
					...
					<form action="{{route('checkpayments',encrypt(Auth::user()->loann))}}" method="POST">
													@csrf
