...
<div class="mt-4">
            ...
            <x-input id="name" class="block mt-1 w-full" type="number" id="total_repayments_amt_payroll" value="{{ old('total_repayments_amt') }}" name="total_repayments_amt" readonly />
            </div> 
...
<div class="mt-4">
            ...
            <x-input id="name" class="block mt-1 w-full" type="number" id="emi_payroll" value="{{ old('emi') }}" name="emi"  readonly/>
            </div> 
