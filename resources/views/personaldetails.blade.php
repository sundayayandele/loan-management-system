...
<!--End fontawesome-->
	...
	<title>PERSONAL DETAILS::KYC FORMS</title>
          ...
          <span class="align-middle">KYC FORMS</span>
              ...
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard</span>
					...
					<form action="#" method="GET">
									...
									<button style="color:white" class="sidebar-link"><i class="align-middle me-1" data-feather="user" ></i>Personal Details</button>  
              ...
              <i class="align-middle" data-feather="user"></i> <span class="align-middle" style="color:white">Next of Kin</span>
					...
					<li class="sidebar-item" >
						...
						<i class="fas fa-building"></i> <br> <span class="align-middle" style="color:white">Employer Details</span>
            </a>
					</li>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="#">
						<i class="fas fa-copy"></i> <br> <span class="align-middle" style="color:white">Attachments</span>
            </a>
					</li>
					...
					<form action="#" method="GET">
													@csrf
											<button style="color:white">Bank Details</button>		
					...
					<li class="sidebar-item">
						...
						<i class="fas fa-check-double"></i> <br> <span class="align-middle" style="color:white">Done</span>
            </a>
					</li>
