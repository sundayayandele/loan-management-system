...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            'can-check-permissions','can-view-web-analytics','can-view-loan-analytics','can-view-charts','can-check-incoming-payments','can-check-todays-payments','can-check-missed-payments','can-check-their-profile',
