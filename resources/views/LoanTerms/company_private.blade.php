...
hr.new2 {
  border-top: dashed black;
          ...
          <p>1.2."The Borrower" - <strong>{{$hold_loan->group_leader_name}}</strong></p>
          ...
          <p>4.1 I<strong> “{{$hold_loan->group_leader_name}}” </strong> hereby acknowledges receipt of ZMW
          ...
          <p>Full Name (Group Representative): <strong>{{$hold_loan->group_leader_name}} </strong></p>
...
<br>
        ...
        <center>
          ...
          <div class="row">
            <div class="column1" >
              <strong>{{ \Carbon\Carbon::today()->addMonths($hold_loan->loan_installments) }}-{{date('F-Y')}}</strong> 
            </div>
...
<br>
        <hr class="new2">
          ...
          <h3>Group Leader Personal Details</h3>          
          ...
          <div class="row">
            <div class="column1" >
               Name(s): <strong>{{$hold_loan->group_leader_name}} </strong>
          ...
          <h3>Group Leader Bank Details:</h3>
